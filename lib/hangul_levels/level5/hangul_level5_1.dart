...
class HangulLevel51 extends StatelessWidget {
  const HangulLevel51({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        LinearProgressIndicator(
          ...
          // Aufbau
          const Text(
            'Nasale Assimilation 1: Endkonsonant wird weicher',
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 6),
          const Text(
            'Wenn zwei Silben aufeinander kommen, können sich die Endkonsonanten der ersten Silbe verändern: ',
...
const SizedBox(height: 12),
          ...
          [
            ...
            Text('국물',style: TextStyle(fontSize: 30))
            ],
            ),
          ...
          [
            ...
            Text('궁믈',style: TextStyle(fontSize: 30))
            ],
            ),
...
Center(child: Column(
  children: [
            Text('ㄱ -> ㅇ',style: TextStyle(fontSize: 30)),

            Text('ㄷ -> ㄴ',style: TextStyle(fontSize: 30)),

            Text('ㅂ -> ㅁ',style: TextStyle(fontSize: 30)),
  ]
),),
...
Center(child: Column(
  children: [
            ...
            Text('ㄴ',style: TextStyle(fontSize: 30)),

            Text('ㅁ',style: TextStyle(fontSize: 30)),
  ]
),),
...
Center(
  child: SingleChildScrollView(
    ...
    child: Column(
      children: [
        _buildAudioCard(context, '국민 - Staatsbürger*in', 'audio/hangul/gukmin.mp3'),
        _buildAudioCard(context, '십만 - 100 000', 'audio/hangul/shibman.mp3'),
        _buildAudioCard(context, '먹는다 - essen', 'audio/hangul/meogneunda.mp3'),
        _buildAudioCard(context, '갑니다 - gehen', 'audio/hangul/gamnida.mp3'),
        _buildAudioCard(context, '감사합니다 - Dankeschön', 'audio/hangul/gamsahamnida.mp3'),
      ],
    ),
  ),
),
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.pushAndRemoveUntil(
                      context,
                      MaterialPageRoute(builder: (_) => HangulLevel50()), // or MainPage()

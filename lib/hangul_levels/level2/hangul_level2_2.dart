...
class HangulLevel22 extends StatelessWidget {
  const HangulLevel22({Key? key}) : super(key: key);
...
class _HangulContentState extends State<_HangulContent> {
  ...
  final List<int> _uiInitialIndexes = [0, 2, 3, 5, 6, 7, 9, 11, 15, 16, 17, 18];
  final List<int> _uiVowelIndexes = [0, 1, 4, 5, 8, 13, 18, 20];
  final List<int> _uiFinalIndexes = [1, 4, 7, 8, 16, 17, 19, 21, 24, 25, 26, 27];
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        LinearProgressIndicator(
          ...
          const Text(
            'Es wird Zeit für drei neue Zeichen: ㅐ, ㅔ und ㅎ. \n\nㅐ (ae) und ㅔ (e) werden genau gleich ausgesprochen, nämlich wie das deutche "e" Sie werden aber verschieden transkribiert. ㅎ (h) ist leicht zu merken, es trägt nämlich einen "Hut". \n\n Beispiele:\n\n 하하 (haha) \n\n 대리기 (daerigi) \n\n 카라테 (karate)',

...
"sudo_yeop_daerigi": ["Sudo Yeop Daerigi", "수도옆대리기", "Handkantenschlag", "Schläge", "Schlag auf oberer Höhe mit der Außenkante der Hand"],
...
"junbi": ["Junbi", "준비", "Vorbereitung", "Im Training", "Kommando fürs Vorbereiten vor einer Übung"],
...
"kima_seogi": ["Kima Seogi", "기마서기", "Reiterstellung", "Fußstellungen", "Symmetrische Fußstellung, Fußspitzen schauen nach vorne, Beine sind gebeugt", "Juchum Seogi [주춤서기]"],
...
"yeok_sudo_momtong_makgi": ["Yeok Sudo Momtong Makgi", "역수도몸통막기", "Innenhandkantenblock", "Blöcke", "Block mit der Innenkante der Hand auf mittlerer Höhe", "Yeok Sudo Jungdan Makgi [역수도중단막기]"],
"jang_gwon_ollyeo_makgi": ["Jang Gwon Ollyeo Makgi", "장권올려막기", "Handballenblock", "Blöcke", "Block nach oben mit dem Handballen"],
"wit_palgup_deulgi": ["Wit Palgup Deulgi", "윗팔굽들기", "Ellenbogen stoß nach oben", "Stöße", "Ellenbogenstoß nach oben"],
...
"san_makgi": ["San Makgi", "산막기", "Doppelblock Oben", "Blöcke", "Block mit beiden Armen auf Kopfhöhe vorne und hinten. Das Chinesische Schriftzeichen für Berg (Koreanisch: San) sieht aus wie dieser Block (山)"],
"du_palmok_arae_makgi": ["Du Palmok Arae Makgi", "두팔목아래막기", "Doppelblock Unten", "Blöcke", "Block mit der Innenkante des Unterarms mit Unterstützung auf unterer Höhe", "Du Palmok Hadan Makgi [두팔목하단기]"],
